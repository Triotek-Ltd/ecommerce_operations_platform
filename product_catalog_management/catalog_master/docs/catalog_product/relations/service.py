"""Relation service seed for catalog_product."""
...
RELATED_DOCS = [{'doc_id': 'catalog_price', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'catalog_visibility_rule', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'catalog_change_log', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'product_record', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'title/category/positioning from product_record'}]
