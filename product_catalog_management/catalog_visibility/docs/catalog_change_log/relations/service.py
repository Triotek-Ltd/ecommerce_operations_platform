"""Relation service seed for catalog_change_log."""
...
RELATED_DOCS = [{'doc_id': 'catalog_product', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'catalog_price', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'catalog_visibility_rule', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'product identity from catalog_product'}]
