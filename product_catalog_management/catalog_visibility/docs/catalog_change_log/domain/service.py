...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['catalog_product', 'catalog_price', 'catalog_visibility_rule'], 'action_targets': {'record': None, 'review': None, 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
