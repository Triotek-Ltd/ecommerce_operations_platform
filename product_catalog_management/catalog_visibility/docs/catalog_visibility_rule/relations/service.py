"""Relation service seed for catalog_visibility_rule."""
...
RELATED_DOCS = [{'doc_id': 'catalog_product', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'catalog_change_log', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'catalog identity from catalog_product'}]
