"""Action registry seed for catalog_visibility_rule."""
...
ALLOWED_ACTIONS = ['create', 'update', 'review', 'activate', 'deactivate', 'archive']
ACTION_RULES: dict[str, dict[str, Any]] = {'create': {'allowed_in_states': ['draft', 'active', 'inactive'], 'transitions_to': None}, 'update': {'allowed_in_states': ['draft', 'active', 'inactive'], 'transitions_to': None}, 'review': {'allowed_in_states': ['draft', 'active', 'inactive'], 'transitions_to': None}, 'activate': {'allowed_in_states': ['draft'], 'transitions_to': 'active'}, 'deactivate': {'allowed_in_states': ['draft', 'active', 'inactive'], 'transitions_to': None}, 'archive': {'allowed_in_states': ['draft', 'active', 'inactive'], 'transitions_to': 'archived'}}
