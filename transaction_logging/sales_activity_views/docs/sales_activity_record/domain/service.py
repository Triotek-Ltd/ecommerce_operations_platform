"""Business-domain service seed for Sales Activity Record."""
...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['order_record', 'commerce_customer_account', 'analytics_report', 'party_record', 'customer_account'], 'action_targets': {'create': None, 'refresh': None, 'archive': 'archived'}, 'action_side_effects_file': None}
