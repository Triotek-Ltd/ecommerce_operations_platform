...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['order_record', 'commerce_customer_account', 'analytics_report'], 'action_targets': {'create': None, 'refresh': None, 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
