"""Relation service seed for sales_activity_record."""
...
RELATED_DOCS = [{'doc_id': 'order_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'commerce_customer_account', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'analytics_report', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'party_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'customer_account', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = [{'source_field': 'party', 'doc_id': 'party_record', 'mode': 'context'}, {'source_field': 'related_order_record', 'doc_id': 'order_record', 'mode': 'context'}, {'source_field': 'related_commerce_customer_account', 'doc_id': 'commerce_customer_account', 'mode': 'context'}, {'source_field': 'source_order_customer', 'doc_id': 'customer_account', 'mode': 'context'}]

BORROWED_FIELDS = [{'description': 'order'}, {'description': 'customer context from linked records'}, {'field_id': 'party', 'doc_id': 'party_record', 'description': 'Borrow context from party_record through party.'}, {'field_id': 'related_order_record', 'doc_id': 'order_record', 'description': 'Borrow context from order_record through related_order_record.'}, {'field_id': 'related_commerce_customer_account', 'doc_id': 'commerce_customer_account', 'description': 'Borrow context from commerce_customer_account through related_commerce_customer_account.'}, {'field_id': 'source_order_customer', 'doc_id': 'customer_account', 'description': 'Borrow context from customer_account through source_order_customer.'}]
