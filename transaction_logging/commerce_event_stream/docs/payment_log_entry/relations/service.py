"""Relation service seed for payment_log_entry."""
...
RELATED_DOCS = [{'doc_id': 'payment_attempt', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'processor_event_log', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'card_authorization_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'mobile_money_transaction', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'payment/provider context from linked records'}]
