...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['payment_attempt', 'processor_event_log', 'card_authorization_record', 'mobile_money_transaction'], 'action_targets': {'record': None, 'normalize': None, 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
