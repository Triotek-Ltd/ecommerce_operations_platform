...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['order_status_event', 'account_activity_log', 'sales_activity_record'], 'action_targets': {'record': None, 'normalize': None, 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
