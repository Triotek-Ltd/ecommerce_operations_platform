"""Business-domain service seed for Commerce Event Log."""
...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['order_status_event', 'account_activity_log', 'sales_activity_record', 'order_customer_product_reference'], 'action_targets': {'record': None, 'normalize': None, 'archive': 'archived'}, 'action_side_effects_file': None}
