...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['commerce_customer_account', 'commerce_event_log', 'purchase_history_snapshot'], 'action_targets': {'record': None, 'review': None, 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
