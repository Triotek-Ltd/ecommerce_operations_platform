"""Action registry seed for purchase_history_snapshot."""
...
ALLOWED_ACTIONS = ['create', 'refresh', 'archive']
ACTION_RULES: dict[str, dict[str, Any]] = {'create': {'allowed_in_states': ['active'], 'transitions_to': None}, 'refresh': {'allowed_in_states': ['active'], 'transitions_to': None}, 'archive': {'allowed_in_states': ['active'], 'transitions_to': 'archived'}}
