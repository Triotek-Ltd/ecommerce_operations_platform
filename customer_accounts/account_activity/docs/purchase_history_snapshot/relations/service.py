"""Relation service seed for purchase_history_snapshot."""
...
RELATED_DOCS = [{'doc_id': 'commerce_customer_account', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'order_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'account_activity_log', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = [{'source_field': 'customer_account', 'doc_id': 'commerce_customer_account', 'mode': 'context'}, {'source_field': 'related_order_record', 'doc_id': 'order_record', 'mode': 'context'}]

BORROWED_FIELDS = [{'description': 'order'}, {'description': 'account context from linked docs'}, {'field_id': 'customer_account', 'doc_id': 'commerce_customer_account', 'description': 'Borrow context from commerce_customer_account through customer_account.'}, {'field_id': 'related_order_record', 'doc_id': 'order_record', 'description': 'Borrow context from order_record through related_order_record.'}]
