...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['commerce_customer_account', 'order_record', 'account_activity_log'], 'action_targets': {'create': None, 'refresh': None, 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
