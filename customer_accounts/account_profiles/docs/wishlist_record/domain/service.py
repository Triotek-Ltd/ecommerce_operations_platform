...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['commerce_customer_account', 'catalog_product', 'order_record'], 'action_targets': {'create': None, 'update': None, 'convert': None, 'remove': None, 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
