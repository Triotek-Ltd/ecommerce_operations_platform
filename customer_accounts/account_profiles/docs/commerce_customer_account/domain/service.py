...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['account_activity_log', 'wishlist_record', 'purchase_history_snapshot', 'customer_account'], 'action_targets': {'create': None, 'update': None, 'suspend': None, 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
