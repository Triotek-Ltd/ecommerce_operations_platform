"""Action registry seed for commerce_customer_account."""
...
ALLOWED_ACTIONS = ['create', 'update', 'suspend', 'archive']
ACTION_RULES: dict[str, dict[str, Any]] = {'create': {'allowed_in_states': ['active', 'suspended'], 'transitions_to': None}, 'update': {'allowed_in_states': ['active', 'suspended'], 'transitions_to': None}, 'suspend': {'allowed_in_states': ['active', 'suspended'], 'transitions_to': None}, 'archive': {'allowed_in_states': ['active', 'suspended'], 'transitions_to': 'archived'}}
