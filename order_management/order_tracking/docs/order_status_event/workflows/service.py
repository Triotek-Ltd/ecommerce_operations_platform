...
ACTION_RULES = {'record': {'allowed_in_states': ['active'], 'transitions_to': None}, 'normalize': {'allowed_in_states': ['active'], 'transitions_to': None}, 'archive': {'allowed_in_states': ['active'], 'transitions_to': 'archived'}}
