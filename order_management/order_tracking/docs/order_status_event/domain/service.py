"""Business-domain service seed for Order Status Event."""
...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['order_record', 'commerce_event_log', 'payment_log_entry'], 'action_targets': {'record': None, 'normalize': None, 'archive': 'archived'}, 'action_side_effects_file': None}
