...
CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state', 'transaction_date'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'transaction_date': 'transaction_date', 'party': 'primary_party', 'currency': 'currency_code', 'total_amount': 'total_amount', 'order_date': 'schedule_marker', 'order_status': 'status_flag'}, 'search_fields': ['title', 'reference_no', 'description', 'order_code', 'source_reference', 'external_account_reference'], 'list_columns': ['title', 'reference_no', 'transaction_date', 'party', 'total_amount', 'workflow_state'], 'initial_state': 'placed', 'lifecycle_states': ['placed', 'confirmed', 'partially_fulfilled', 'fulfilled', 'cancelled', 'closed', 'archived'], 'terminal_states': ['closed', 'archived'], 'action_targets': {'create': None, 'confirm': 'confirmed', 'update_status': None, 'cancel': None, 'close': 'closed', 'archive': 'archived'}}
