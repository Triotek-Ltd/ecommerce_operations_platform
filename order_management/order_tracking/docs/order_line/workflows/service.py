"""Workflow service seed for order_line."""
...
STATES = ['active', 'fulfilled', 'cancelled', 'returned', 'archived']
TERMINAL_STATES = ['archived']
ACTION_RULES: dict[str, dict[str, Any]] = {'record': {'allowed_in_states': ['active', 'fulfilled', 'cancelled', 'returned'], 'transitions_to': None}, 'update_status': {'allowed_in_states': ['active', 'fulfilled', 'cancelled', 'returned'], 'transitions_to': None}, 'archive': {'allowed_in_states': ['active', 'fulfilled', 'cancelled', 'returned'], 'transitions_to': 'archived'}}
