...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['order_record', 'catalog_product', 'fulfillment_case'], 'action_targets': {'record': None, 'update_status': None, 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
