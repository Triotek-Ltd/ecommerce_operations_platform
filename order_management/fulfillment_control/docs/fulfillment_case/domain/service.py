...
CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'related_order_record': 'relation_collection', 'related_order_line': 'relation_collection', 'related_shipment_record': 'relation_collection', 'related_delivery_exception_case': 'relation_collection'}, 'search_fields': ['title', 'reference_no', 'description', 'case_code', 'source_order_or_line', 'fulfillment_issue_type'], 'list_columns': ['title', 'reference_no', 'workflow_state', 'modified'], 'initial_state': 'opened', 'lifecycle_states': ['opened', 'assigned', 'in_progress', 'resolved', 'escalated', 'closed', 'archived'], 'terminal_states': ['closed', 'archived'], 'action_targets': {'create': None, 'assign': 'in_progress', 'review': None, 'resolve': 'resolved', 'escalate': 'escalated', 'close': 'closed', 'archive': 'archived'}}
...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['order_record', 'order_line', 'shipment_record', 'delivery_exception_case'], 'action_targets': {'create': None, 'assign': 'in_progress', 'review': None, 'resolve': 'resolved', 'escalate': 'escalated', 'close': 'closed', 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
