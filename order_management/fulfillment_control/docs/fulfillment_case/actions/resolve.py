"""Action handler seed for fulfillment_case:resolve."""
...
ACTION_ID = "resolve"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['opened', 'assigned', 'in_progress', 'resolved', 'escalated'], 'transitions_to': 'resolved'}
