"""Action handler seed for fulfillment_case:create."""
...
ACTION_ID = "create"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['opened', 'assigned', 'in_progress', 'resolved', 'escalated'], 'transitions_to': None}
