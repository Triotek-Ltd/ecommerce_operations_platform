"""Relation service seed for refund_case."""
...
DOC_ID = "refund_case"
RELATED_DOCS = [{'doc_id': 'payment_attempt', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'adjustment_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'chargeback_case', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'marketplace_return_case', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'source payment/order context from linked records'}]
