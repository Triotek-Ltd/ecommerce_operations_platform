"""Action registry seed for adjustment_record."""
...
ALLOWED_ACTIONS = ['record', 'apply', 'archive']
ACTION_RULES: dict[str, dict[str, Any]] = {'record': {'allowed_in_states': ['draft', 'applied'], 'transitions_to': None}, 'apply': {'allowed_in_states': ['draft', 'applied'], 'transitions_to': None}, 'archive': {'allowed_in_states': ['draft', 'applied'], 'transitions_to': 'archived'}}
