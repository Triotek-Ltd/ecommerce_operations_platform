"""Workflow service seed for checkout_session."""
...
INITIAL_STATE = 'open'
STATES = ['open', 'in_progress', 'completed', 'abandoned', 'failed', 'archived']
TERMINAL_STATES = ['archived']
ACTION_RULES = {'create': {'allowed_in_states': ['open', 'in_progress', 'completed', 'abandoned', 'failed'], 'transitions_to': None}, 'start': {'allowed_in_states': ['open', 'in_progress', 'completed', 'abandoned', 'failed'], 'transitions_to': None}, 'complete': {'allowed_in_states': ['open', 'in_progress', 'completed', 'abandoned', 'failed'], 'transitions_to': None}, 'abandon': {'allowed_in_states': ['open', 'in_progress', 'completed', 'abandoned', 'failed'], 'transitions_to': None}, 'fail': {'allowed_in_states': ['open', 'in_progress', 'completed', 'abandoned', 'failed'], 'transitions_to': None}, 'archive': {'allowed_in_states': ['open', 'in_progress', 'completed', 'abandoned', 'failed'], 'transitions_to': 'archived'}}
