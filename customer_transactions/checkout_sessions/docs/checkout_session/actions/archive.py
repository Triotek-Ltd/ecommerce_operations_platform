"""Action handler seed for checkout_session:archive."""
...
ACTION_ID = "archive"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['open', 'in_progress', 'completed', 'abandoned', 'failed'], 'transitions_to': 'archived'}
