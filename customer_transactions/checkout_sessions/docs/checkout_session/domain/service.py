...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['payment_attempt', 'order_record', 'commerce_customer_account'], 'action_targets': {'create': None, 'start': None, 'complete': None, 'abandon': None, 'fail': None, 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
