...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['checkout_session', 'order_record', 'payment_intent_record', 'card_authorization_record', 'mobile_money_transaction'], 'action_targets': {'create': None, 'authorize': None, 'confirm': None, 'fail': None, 'cancel': None, 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
